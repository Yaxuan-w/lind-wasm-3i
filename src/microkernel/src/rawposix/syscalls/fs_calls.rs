...
use syscall_adapter::syscall_handler;
...
#[syscall_handler(fd = "convert_fd", path = "convert_path_lind2host", buf = "convert_buf")]
pub fn open_syscall(cageid: u64, path: u64, oflag_arg: u64, mode_arg: u64, _arg4: u64, _arg5: u64, _arg6: u64) -> i32 {
...
#[syscall_handler(fd = "convert_fd", path = "convert_path_lind2host", buf = "convert_buf")]
pub fn mkdir_syscall(cageid: u64, path: u64, mode_arg: u64, _arg3: u64, _arg4: u64, _arg5: u64, _arg6: u64) -> i32 {
    let ret = unsafe {
...
#[syscall_handler(fd = "convert_fd", path = "convert_path_lind2host", buf = "convert_buf")]
pub fn write_syscall(cageid: u64, fd: u64, buf: u64, count_arg: u64, _arg4: u64, _arg5: u64, _arg6: u64) -> i32 {
    ...
    let ret = unsafe {
        libc::write(fd, buf, count) as i32
    };
